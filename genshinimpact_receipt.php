...
<head>
    ...
    <title>Order Receipt - Genshin Impact</title>
...
<body>
    <section class="receipt">
        ...
        <p id="order-message">
            <?php
                ...
                if ($gameName === 'Genshin Impact') {
                    echo "Your purchase of $itemAmount Primogems has been successfully processed and added to your Genshin Impact account.";
                } else {
        ...
        <div class="order-summary">
            ...
            <p><strong>Item Purchased:</strong> <?php echo htmlspecialchars($itemAmount) . " Primogems"; ?></p>
