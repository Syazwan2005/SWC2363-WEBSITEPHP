...
$playerId = isset($_GET['playerId']) ? $_GET['playerId'] : 'N/A'; // Using Player ID
...
<head>
    ...
    <title>Order Receipt - Black Clover M</title>
...
<body>
    ...
    <section class="receipt">
        ...
        <p id="order-message">
            <?php
                // Custom thank-you message for Black Clover M
                if ($gameName === 'Black Clover M') {
                    echo "The $itemAmount items have been added to your Black Clover M account.";
                } else {
