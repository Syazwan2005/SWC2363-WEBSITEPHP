...
<head>
    ...
    <title>Order Receipt - Honor of Kings</title>
...
<body>
    <section class="receipt">
        ...
        <p id="order-message">
            <?php
                // Custom thank-you message for Honor of Kings
                if ($gameName === 'Honor of Kings') {
                    echo "The $itemAmount Tokens have been successfully added to your Honor of Kings account.";
                } else {
        ...
        <div class="order-summary">
            ...
            <p><strong>Tokens Purchased:</strong> <?php echo htmlspecialchars($itemAmount) . " Tokens"; ?></p>
