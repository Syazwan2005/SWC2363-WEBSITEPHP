...
$riotId = isset($_GET['riotId']) ? $_GET['riotId'] : 'N/A';  // Changed to Riot ID
...
<head>
    ...
    <title>Order Receipt - Wild Rift</title>
...
<body>
    <section class="receipt">
        ...
        <p id="order-message">
            <?php
                // Custom thank-you message for Wild Rift
                if ($gameName === 'League of Legends: Wild Rift') {
                    echo "The $itemAmount Wild Cores have been added to your Wild Rift account.";
                } else {
        ...
        <div class="order-summary">
            ...
            <p><strong>Riot ID:</strong> <?php echo htmlspecialchars($riotId); ?></p>  <!-- Displaying Riot ID -->
            <p><strong>Item Purchased:</strong> <?php echo htmlspecialchars($itemAmount) . " Wild Cores"; ?></p>
